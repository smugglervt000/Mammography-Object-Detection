...
def main():
    ...
    wandb_logger = WandbLogger(project='Retinanet', name='massfil_vindr_0ns_final') 
    ...
    trainer = L.Trainer(max_epochs=100, logger=wandb_logger, devices=2, callbacks=[checkpoint_callback, checkpoint_callback_best, early_stopping_callback])
